...
from .views import fillSurvey, ListSurveyCBV, export_survey_home, export_single_survey_view, export_patient_surveys_view, export_surveys_single_person_view, export_surveys_view
...
urlpatterns = [
    ...
    path('esporta-questionari/esporta-questionari-singolo-paziente/', export_surveys_single_person_view, name="export_surveys_single_person"),
    path('esporta-questionari/esporta-questionari/', export_surveys_view, name="export_surveys"),
